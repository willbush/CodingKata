...
public class GameScreen extends Screen {
    ...
    private Image robotImageState, character, character2, character3, heliboy,
    ...
    private void updateRunning(List<TouchEvent> touchEvents, float deltaTime) {
        ...
        robot.update();
        if (robot.isJumped()) {
            robotImageState = Assets.characterJump;
    ...
    private void handleTouchInput(List<TouchEvent> touchEvents) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (event.type == TouchEvent.TOUCH_DOWN) {
                ...
                if (inBounds(event, 0, 285, 65, 65)) {
                    ...
                    robotImageState = Assets.characterDown;
    ...
    private void drawHeliEnemy(Graphics g) {
        g.drawImage(heliAnim.getImage(), hb.getCenterX() - 48,
                hb.getCenterY() - 48);
        g.drawImage(heliAnim.getImage(), hb2.getCenterX() - 48,
                hb2.getCenterY() - 48);
    }
