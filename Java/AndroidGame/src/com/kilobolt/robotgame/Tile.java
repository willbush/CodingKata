...
public class Tile {
    ...
    private void handleTileCollision() {
        if (Rect.intersects(r, Robot.checkForCollisionArea) && type != 0) {
            checkVerticalCollision(Robot.rect, Robot.rect2);
            checkHorizontalCollision(Robot.rect3, Robot.rect4, Robot.footleft,
                    Robot.footright);
        }
    }
    ...
    public void checkHorizontalCollision(Rect rleft, Rect rright,
